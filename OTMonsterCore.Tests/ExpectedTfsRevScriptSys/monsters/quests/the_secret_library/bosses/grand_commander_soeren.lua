...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = -200, maxDamage = -720, type = COMBAT_PHYSICALDAMAGE, range = 7, shootEffect = CONST_ANI_ROYALSPEAR, target = false},
	{name ="combat", interval = 1000, chance = 14, minDamage = -500, maxDamage = -1000, type = COMBAT_HOLYDAMAGE, length = 8, spread = 3, effect = CONST_ME_BLOCKHIT, target = false}
}

monster.defenses = {
	defense = 50,
	armor = 82,
	{name ="combat", interval = 2000, chance = 20, minDamage = 200, maxDamage = 650, type = COMBAT_HEALING, effect = CONST_ME_MAGIC_BLUE, target = false}
}
