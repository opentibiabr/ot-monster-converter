...
monster.loot = {
	...
	{id = "assassin star", chance = 13600000, maxCount = 9},
	{id = "black pearl", chance = 13600000, maxCount = 2},
	{id = "great mana potion", chance = 13600000, maxCount = 2},
	{id = "great spirit potion", chance = 13600000, maxCount = 2},
	{id = "small enchanted emerald", chance = 13600000, maxCount = 2},
	{id = "ultimate mana potion", chance = 13600000, maxCount = 2},
	{id = "ultimate spirit potion", chance = 13600000, maxCount = 2},
	{id = "fox paw", chance = 13600000, maxCount = 2},
	{id = "moonlight rod", chance = 13600000},
	{id = "stealth ring", chance = 13600000},
	{id = "werefox tail", chance = 13600000},
	{id = "green gem", chance = 400},
	{id = "troll green", chance = 400},
	{id = "werewolf amulet", chance = 400},
	{id = "composite hornbow", chance = 250},
	{id = "sai", chance = 250},
	{id = "silver token", chance = 250},
	{id = 30941, chance = 250},
	{id = "foxtail", chance = 100},
	{id = "wolf backpack", chance = 100},
	{id = "silver token", chance = 100}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -290, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 1000, chance = 20, minDamage = 100, maxDamage = 720, type = COMBAT_PHYSICALDAMAGE, range = 7, shootEffect = CONST_ANI_THROWINGSTAR, target = false},
