...
monster.attacks = {
	...
	{name ="combat", interval = 1500, chance = 15, minDamage = -300, maxDamage = -500, type = COMBAT_EARTHDAMAGE, shootEffect = CONST_ANI_ENVENOMEDARROW, target = true},
	...
	{name ="combat", interval = 1500, chance = 20, minDamage = -300, maxDamage = -650, type = COMBAT_EARTHDAMAGE, effect = CONST_ME_GREEN_RINGS, target = true}
}
