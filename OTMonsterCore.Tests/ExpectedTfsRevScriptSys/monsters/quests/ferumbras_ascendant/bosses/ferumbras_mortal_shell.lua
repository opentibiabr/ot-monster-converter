...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, minDamage = -425, maxDamage = -810, type = COMBAT_MANADRAIN, effect = CONST_ME_MAGIC_BLUE, target = false},
	{name ="combat", interval = 2000, chance = 21, minDamage = -400, maxDamage = -650, type = COMBAT_ENERGYDAMAGE, effect = CONST_ME_ENERGYHIT, target = false},
