...
monster.defenses = {
	defense = 165,
	armor = 155,
	{name ="combat", interval = 2000, chance = 22, minDamage = 440, maxDamage = 800, type = COMBAT_HEALING, effect = CONST_ME_DRAWBLOOD, target = false},
	{name ="combat", interval = 2000, chance = 50, target = false},
