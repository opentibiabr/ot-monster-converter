...
monster.attacks = {
	...
	{name ="combat", interval = 1000, chance = 6, minDamage = -150, maxDamage = -350, type = COMBAT_MANADRAIN, effect = CONST_ME_POISONAREA, target = false},
	{name ="combat", interval = 1000, chance = 6, effect = CONST_ME_HITAREA, target = false},
	{name ="combat", interval = 1000, chance = 34, minDamage = -310, maxDamage = -600, type = COMBAT_FIREDAMAGE, range = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},
...
monster.defenses = {
	defense = 111,
	armor = 90,
	{name ="combat", interval = 1000, chance = 9, minDamage = 1500, maxDamage = 2500, type = COMBAT_HEALING, effect = CONST_ME_MAGIC_BLUE, target = false},
	{name ="combat", interval = 1000, chance = 17, minDamage = 600, maxDamage = 1000, type = COMBAT_HEALING, effect = CONST_ME_MAGIC_BLUE, target = false},
