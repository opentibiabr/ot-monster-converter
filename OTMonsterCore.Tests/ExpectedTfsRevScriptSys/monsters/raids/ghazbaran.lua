...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 40, minDamage = -250, maxDamage = -500, type = COMBAT_PHYSICALDAMAGE, range = 7, effect = CONST_ME_HITAREA, target = false},
	{name ="combat", interval = 3000, chance = 34, minDamage = -120, maxDamage = -500, type = COMBAT_PHYSICALDAMAGE, range = 7, shootEffect = CONST_ANI_WHIRLWINDSWORD, effect = CONST_ME_DRAWBLOOD, target = true},
	...
	{name ="combat", interval = 3000, chance = 15, minDamage = -200, maxDamage = -750, type = COMBAT_PHYSICALDAMAGE, range = 7, effect = CONST_ME_ENERGYAREA, target = false}
}
