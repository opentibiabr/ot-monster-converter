...
monster.attacks = {
	...
	{name ="combat", interval = 1000, chance = 15, minDamage = -40, maxDamage = -120, type = COMBAT_EARTHDAMAGE, range = 7, shootEffect = CONST_ANI_POISON, target = false},
	...
	{name ="combat", interval = 1000, chance = 8, minDamage = -35, maxDamage = -85, type = COMBAT_EARTHDAMAGE, length = 8, spread = 3, effect = CONST_ME_GREEN_RINGS, target = false},
