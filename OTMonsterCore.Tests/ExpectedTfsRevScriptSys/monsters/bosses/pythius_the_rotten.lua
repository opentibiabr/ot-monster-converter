...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 16, minDamage = -165, maxDamage = -200, type = COMBAT_PHYSICALDAMAGE, range = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_DRAWBLOOD, target = true},
	{name ="combat", interval = 2000, chance = 17, minDamage = -55, maxDamage = -155, type = COMBAT_EARTHDAMAGE, range = 7, shootEffect = CONST_ANI_POISON, effect = CONST_ME_POISONAREA, target = true},
	...
	{name ="combat", interval = 2500, chance = 22, minDamage = -85, maxDamage = -110, type = COMBAT_MANADRAIN, range = 7, shootEffect = CONST_ANI_ICE, target = true},
	{name ="speed", interval = 2000, chance = 20, speedChange = -300, duration = 30000},
	-- curse
	{name ="combat", type = COMBAT_FIX_ME, interval = 2000, chance = 15, range = 7, shootEffect = CONST_ANI_ICE, effect = CONST_ME_ICEATTACK, target = true}
}
